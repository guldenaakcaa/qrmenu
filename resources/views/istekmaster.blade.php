...
<footer class="footer mt-auto py-3">
    ...
    <div class="container-fluid">
        <p class="text-center"> {{ $ayar->baslik }} </p>
        <div class="whatsapp">
            ...
            <a href="https://wa.me/{{ $ayar->telefon }}" target="_blank" rel="noreferrer"
                class="ml-2 text-center">Whatsapp Hattı
                {{ $ayar->telefon }}</a>
        </div>
    </div>
</footer>
