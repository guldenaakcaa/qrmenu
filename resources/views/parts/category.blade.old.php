...
<div class="col-6 col-md-3">
    <div class="card border-0 shadow-light text-center mb-4">
        <div class="card-body position-relative">
            ...
            <div class="h-100px position-relative overflow-hidden">
                <a class="text-default" href="{{route('product', $urun->Urun_id)}}">
                    <div class="background background-h-100">
                        <img src="{{ asset('/assets/img/urunler')}}/{{$urun->UrunResimPath}}" alt="" style="display: block;width: 100%;margin-left: auto;margin-right: auto;">
                    </div>
                </a>
            </div>
            <a class="text-default" href="{{route('product', $urun->Urun_id)}}">
            ...
            <p class="small">{{$urun->UrunGrubu}}<br><span class="text-warning icon_star"></span><span class="text-warning icon_star"></span><span class="text-warning icon_star"></span><span class="text-warning icon_star"></span><span class="text-warning icon_star"></span></p>
            <div class="row">
