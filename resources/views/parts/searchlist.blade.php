@foreach ($ugrup as $u)
    <button onclick='btnGrupClick(this)' value='{{ $u->UrunGrubu_id }}' class="category omaclasse"
        style="background-image: url(assets/img/kategoriler/{{ $u->UrunGrubuResimPath }})">
        <div class="overlay"></div>
        <div class="content">
            <div class="category-text">{{ __($u->Urungrubu) }}</div>
